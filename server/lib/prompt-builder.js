...
function buildUserPrompt(agentKey, rootDir, scope, audit) {
  ...
  parts.push(`Framework: ${framework} | Total LOC: ${totalLoc} | Scope Notes: ${audit?.scopeNotes || 'none'}`);
  parts.push('');
